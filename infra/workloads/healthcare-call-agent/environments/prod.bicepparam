...
param sqlAdminPassword = ''  // REQUIRED: Set before deployment (e.g., az deployment sub create --parameters @prod.bicepparam sqlAdminPassword='...')
...
param appServicePlanSku = 'P1V2'  // Premium tier for production
